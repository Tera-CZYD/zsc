...
?>
  ...
  $cleanedString = str_replace("REQ-", "", $data['RequestForm']['code']);

  $txnid = '0'.$cleanedString;

  $txnid = $data['RequestForm']['code'];

  $description = $data['RequestForm']['purpose'];
  ...
  <div class="form-container">
    <div style="display: flex;">
      ...
      <div style="flex: 1; display: flex; justify-content: center; align-items: center;">
        <img src="<?php echo $this->base ?>/assets/img/payment.png" alt="Image" style="max-width: 100%; max-height: 100%;">
      </div>
    </div>
  </div>
</body>
