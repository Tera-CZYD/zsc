          ...
          <div class="form-group">
            <label>EMPLOYEE STATUS</label>
              <div class="input-group mb-3">
                ...
                <select class="form-control input-sm uppercase" ng-model="search.employmentStatusId" ng-options="opt.id as opt.value for opt in statuses" data-validation-engine="validate[required]">
              </select>
              </div>
          </div>
        </div>
