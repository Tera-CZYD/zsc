    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <label>COLLEGE</label>
            <select class="form-control" ng-model="search.college_id" ng-options="opt.id as opt.value for opt in colleges" data-validation-engine="validate[required]">
              <option value=""></option>
            </select>
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            <label>DEGREE</label>
            <select class="form-control" ng-model="search.degree_id" ng-options="opt.id as opt.value for opt in degrees" data-validation-engine="validate[required]">
              <option value=""></option>
            </select>
          </div>
        </div>
