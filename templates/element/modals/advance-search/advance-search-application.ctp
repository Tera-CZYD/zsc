  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div ng-show="search.filterBy == 'application-type'">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <select class="form-control input-sm uppercase" ng-model="search.application_type">
                  <option value=""></option>
                  <option value="A">WALK IN APPLICANTION</option>
                  <option value="O">ONLINE APPLICANTION</option>
                </select>
              </div>
            </div>
          </div>
