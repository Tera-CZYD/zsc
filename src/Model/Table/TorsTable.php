<?php
  ...
  class TorsTable extends Table{
    ...
    public function getAllTor($conditions, $limit, $page){
    ...
    public function getAllTorPrint($conditions){
    ...
    public function paginate($query, array $options = []){
      ...
      $result = $this->getAllTor($conditions, $limit, $page)->fetchAll('assoc');
