...
class TorsController extends AppController {
  ...
  public function index(){   
    ...
    $dataTable = TableRegistry::getTableLocator()->get('Tors');

    $limit = 25;

    $tmpData = $dataTable->paginate($dataTable->getAllTor($conditions, $limit, $page), [
    ...
    foreach ($tors as $tor) {
      ...
      $datas[] = array(
        ...
        'full_name'   => $tor['full_name'],

        'student_no'  => $tor['student_no'],
