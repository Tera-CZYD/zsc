...
<html>
<head>
  <title> CHANGE OF PROGRAM - CONFIRMED </title>
...
<body>
  ...
  <h5>Program successfully changed.</h5>
  ...
  <tr>
    <td><center><h1 style="background-color:#ffe6f2; color:black;"> CHANGE OF PROGRAM </h1></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: left;"><strong> PREFERRED PROGRAM :</strong><i> <?php echo $_SESSION['pref_prog'];?> </i></td>
  </tr>
  <tr>
