...
<body>
  ...
  <tr>
    <td><center><h1 style="background-color:#ffe6f2; color:black;"> TRANSFER STUDENT CREDENTIALS </h1></center></td>
  </tr>
  <tr>
  ...
  Note:
  <p>Your Application for transfer is now Approved you may now login to the portal.</p>
