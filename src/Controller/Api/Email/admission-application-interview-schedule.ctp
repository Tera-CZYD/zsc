...
<html>
<head>
  <title> MEDICAL INTERVIEW SCHEDULE </title>
...
<body>
  ...
  <h4>Medical Interview Schedule.</h4>
  ...
  <tr>
    <td><center><h1 style="background-color:#ffe6f2; color:black;"> Medical Interview Schedule </h1></center></td>
  </tr>
  <tr>
