        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <?php if (hasAccess('specialization management/add', $currentUser)): ?>
                <a href="#/faculty/specialization/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
              <?php endif ?> 
...
<!--                       <?php if (hasAccess('specialization management/view', $currentUser)): ?>
                      	<a href="#/faculty/specialization/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                      <?php endif ?>  -->
                      <?php if (hasAccess('specialization management/edit', $currentUser)): ?>
                      	<a href="#/faculty/specialization/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
                      <?php endif ?> 
                      <?php if (hasAccess('specialization management/delete', $currentUser)): ?>
