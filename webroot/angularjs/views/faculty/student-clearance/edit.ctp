          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control uppercase" autocomplete="off" ng-model="data.StudentClearance.serial_number" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select selectize ng-model="data.StudentClearance.year_term_id" ng-options="opt.id as opt.value for opt in year_terms" ng-change = "getYear(data.ScholarshipApplication.year_term_id)">
                  <option value=""></option>
                </select>
              </div>
            </div>
