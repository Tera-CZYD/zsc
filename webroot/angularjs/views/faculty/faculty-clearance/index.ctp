<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'faculty clearance/index', currentUser);
  handleAccess('pageAdd', 'faculty clearance/add', currentUser);
  handleAccess('pagePrint', 'faculty clearance/print', currentUser);
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    <a id="pageAdd" href="#/faculty/faculty-clearance/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                    ...
                    <td class="text-center">{{ data.request }}</td>
                      <td>
                        <div class="btn-group btn-group-xs">
                            <a id="pageView" href="#/faculty/faculty-clearance/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                            <a id="pageEdit" href="#/faculty/faculty-clearance/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
