  ...
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        ...
        <div class="col-md-8">
          <h4 class="header-title">REFERRAL SLIP</h4>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <a id="pageAdd" href="#/faculty/referral-slip/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD </a>
                ...
                <tr ng-repeat="data in datas">
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                      <a id="pageView" href="#/faculty/referral-slip/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                      <a id="pageEdit" href="#/faculty/referral-slip/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
