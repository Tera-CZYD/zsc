<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'building management/index', currentUser);
  handleAccess('pageAdd', 'building management/add', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">BUILDING MANAGEMENT</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <a id="pageAdd" href="#/building/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-left">{{ data.floors }}</td>
                  <td>
                    <div class="btn-group btn-group-xs">
                    	<a id="pageView" href="#/building/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                    	<a id="pageEdit" href="#/building/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
