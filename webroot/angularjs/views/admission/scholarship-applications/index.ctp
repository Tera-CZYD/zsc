                      ...
                      <tr ng-repeat="data in datas">
                        ...
                        <td>
                          <div class="btn-group btn-group-xs">
                            <a href="#/admission/scholarship-application/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                            <a href="#/admission/scholarship-application/edit/{{ data.id }}" class="btn btn-primary" ng-disabled="data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a>
...
=======
>>>>>>> bb4710e1813369247b66d6c4171000441b3f7472
