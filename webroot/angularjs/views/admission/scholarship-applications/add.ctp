          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <label>
                  <input type="radio" ng-model="data.ScholarshipApplication.sex" value="Male">Male
                </label>&nbsp; &nbsp;&nbsp; &nbsp;
                <label>
                  <input type="radio" ng-model="data.ScholarshipApplication.sex" value="Female">Female
                </label>
              </div>
            </div>
