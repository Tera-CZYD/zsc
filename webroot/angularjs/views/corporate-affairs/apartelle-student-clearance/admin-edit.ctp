...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">EDIT APARTELLE STUDENT CLEARANCE</div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <table class="table table-bordered">
                  <tr>
                    <td style="{{ data.ApartelleStudentClearance.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="uppercase">{{ data.ApartelleStudentClearance.student_name }}</td>
                    <td style="{{ data.ApartelleStudentClearance.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.ApartelleStudentClearance.student_name == undefined">
                      <button class="btn btn-xs btn-sm  btn-danger" ng-click="data.ApartelleStudentClearance.student_name = null; data.ApartelleStudentClearance.student_id = null;" ng-init="data.ApartelleStudentClearance.student_id = null"><i class="fa fa-times"></i></button>
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select selectize ng-options="opt.id as opt.value for opt in college_program" ng-model="data.ApartelleStudentClearance.program_id" data-validation-engine="validate[required]">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select selectize ng-model="data.ApartelleStudentClearance.year_term_id" ng-options="opt.id as opt.value for opt in year_terms" ng-change = "getYear(data.ApartelleRegistration.year_term_id)">
                  <option value=""></option>
                </select>
              </div>
            </div>
