      ...
      <div class="card-body">
        ...
        <form id="form">
          ...
          <div class="col-md-12 table-wrapper">
            ...
            <div class="col-md-12">
              <div class="col-md-3">
                <button id="pageEdit" type="button" class="btn btn-primary btn-min" data-toggle="modal" ng-click="addMiscellaneous()"><i class="fa fa-plus"></i> ADD MISCELLANEOUS</button>
              </div>
            </div>
