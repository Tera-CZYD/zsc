<?php if (hasAccess('requested form payment/view', $currentUser)): ?>
<div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="pull-right">
              <?php if (hasAccess('requested form payment/approve', $currentUser)): ?>
                <button href="javascript:void(0)" ng-click="approve(data.RequestedFormPayment,data.remarks)" ng-disabled="data.RequestedFormPayment.approve == 1" class="btn btn-warning  btn-min" ><i class="fa fa-check"></i> APPROVE </button>
              <?php endif ?>
              
              <?php if (hasAccess('requested form payment/delete', $currentUser)): ?> 
                <button class="btn btn-danger btn-min" ng-click="remove(data.RequestedFormPayment)"><i class="fa fa-trash"></i> DELETE </button>
              <?php endif ?>
            </div>
          </div>
        </div>
