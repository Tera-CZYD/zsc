<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'requested form payment/index', currentUser);
  handleAccess('pagePrint', 'requested form payment/print', currentUser);
                    ...
                    <tr ng-repeat="data in datas">
                      ...
                      <td>
                        <div class="btn-group btn-group-xs">
                            <a id="pageView" href="#/cashier/requested-form-payment/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
