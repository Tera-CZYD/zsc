...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">PAYMENT FOR REQUESTED FORMS</h4>
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                  ...
                  <?php if (hasAccess('requested form payment/print', $currentUser)): ?>
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    <tr ng-repeat="data in datas">
                      ...
                      <td class="text-left">{{ data.student_no }}</td>
                      ...
                      <td>
                        <div class="btn-group btn-group-xs">
                          <?php if (hasAccess('requested form payment/view', $currentUser)): ?>
                            <a href="#/cashier/requested-form-payment/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                          <?php endif ?> 
