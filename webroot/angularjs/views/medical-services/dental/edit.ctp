          ...
          <div class="row">
            <div class="col-md-9">
              <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="false" ng-model="data.Dental.serial_number" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <tr ng-repeat="data in DentalImage">
