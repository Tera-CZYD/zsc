...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">EDIT ITEM ISSUANCE</div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" autocomplete="false" ng-model="data.ItemIssuance.type" data-validation-engine="validate[required]" disabled="">
                  <option value=""></option>
            ...
            <div class="col-md-6" ng-show="data.ItemIssuance.type == 'Dental'">
              <div class="form-group">
                ...
                <select selectize ng-model="data.ItemIssuance.dental_id" ng-options="opt.id as opt.value for opt in dentals" data-validation-engine="validate[required]" ng-change="getDental(data.ItemIssuance.dental_id)" disabled="">
                  <option value=""></option>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-6" ng-show="data.ItemIssuance.type == 'Consultation'">
              <div class="form-group">
                ...
                <select selectize ng-model="data.ItemIssuance.consultation_id" ng-options="opt.id as opt.value for opt in consultations" data-validation-engine="validate[required]" ng-change="getConsultation(data.ItemIssuance.consultation_id)" disabled="">
                  <option value=""></option>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control datepicker" autocomplete="off" ng-model="data.ItemIssuance.date" data-validation-engine="validate[required]" disabled="">
              </div>
            </div>
