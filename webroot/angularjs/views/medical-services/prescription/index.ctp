<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'prescription/index', currentUser);
  handleAccess('pageAdd', 'prescription/add', currentUser);
  handleAccess('pagePrint', 'prescription/print', currentUser);
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-8 col-xs-12">
              <h4 class="header-title">MEDICAL DENTAL OTHERS</h4>
            </div>
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    <a id="pageAdd" href="#/medical-services/prescription/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                    ...
                    <td class="text-center">{{ data.date }}</td>
                      <td>
                        <div class="btn-group btn-group-xs">
                          <a id="pageView" href="#/medical-services/prescription/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          <a id="pageEdit" href="#/medical-services/prescription/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
