<script type="text/javascript">
  ...
  handleAccess('pageView', 'property & equipment/view', currentUser);
  handleAccess('pageEdit', 'property & equipment/edit', currentUser);
  handleAccess('pageDelete', 'property & equipment/delete', currentUser);
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="pull-right">
                <a id="pageEdit" href="#/medical-services/property-log/edit/{{ data.PropertyLog.id }}" class="btn btn-primary btn-min"><i class="fa fa-edit"></i> EDIT </a>
                <button id="pageDelete" class="btn btn-danger btn-min" ng-click="remove(data.PropertyLog)"><i class="fa fa-trash"></i> DELETE </button>
            </div>
          </div>
        </div>
      </div>
