          ...
          <div class="row">
            <div class="col-md-9">
              <div class="form-group">
                ...
                <input type="text" class="form-control"ng-model="data.MedicalCertificate.serial_number">
              </div> 
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" autocomplete="false" ng-model="data.MedicalCertificate.classification" ng-change="getMember(data.MedicalCertificate.classification)" ng-init="data.MedicalCertificate.classification = 'Student'" data-validation-engine="validate[required]">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select selectize ng-model="data.MedicalCertificate.program_id" ng-options="opt.id as opt.value for opt in college_program" ng-change="getCourse(data.MedicalCertificate.program_id)" data-validation-engine="validate[required]">
                  <option value=""></option>
                </select>
              </div>
            </div>
