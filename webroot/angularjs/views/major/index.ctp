<?php if (hasAccess('major management/index', $currentUser)): ?>
<div class="row">
          ...
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <?php if (hasAccess('major management/add', $currentUser)): ?>
                <a href="#/major/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
              <?php endif ?> 
                ...
                <tr ng-repeat="data in datas">
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                      <?php if (hasAccess('major management/edit', $currentUser)): ?>
                        <a href="#/major/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
                      <?php endif ?> 
                      <?php if (hasAccess('major management/delete', $currentUser)): ?>
