<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'affidavit of loss/index', currentUser);
  handleAccess('pageAdd', 'affidavit of loss/add', currentUser);
  handleAccess('pagePrint', 'affidavit of loss/print', currentUser);
                    ...
                    <tr ng-repeat="data in datas">
                      ...
                      <td>
                        <div class="btn-group btn-group-xs">
                          <a id="pageView" href="#/registrar/admin-affidavit-of-loss/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          <a id="pageEdit" href="#/registrar/admin-affidavit-of-loss/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
