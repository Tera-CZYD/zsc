...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">AFFIDAVIT OF LOSS</h4>
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                  <?php if (hasAccess('affidavit of loss/add', $currentUser)): ?>
                    <a href="#/registrar/admin-affidavit-of-loss/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                  <?php endif ?>
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    <tr ng-repeat="data in datas">
                      ...
                      <td class="text-left">{{ data.form }}</td>
                      <td class="text-center">{{ data.date }}</td>
                      <td>
                        <div class="btn-group btn-group-xs">
                          <?php if (hasAccess('affidavit of loss/view', $currentUser)): ?>
                          <a href="#/registrar/admin-affidavit-of-loss/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          <?php endif ?>
                          <?php if (hasAccess('affidavit of loss/edit', $currentUser)): ?>
                          <a href="#/registrar/admin-affidavit-of-loss/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
                          <?php endif ?>
