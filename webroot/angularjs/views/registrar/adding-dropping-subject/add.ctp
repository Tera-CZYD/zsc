...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">ADD COURSE SUBJECT</div>
          ...
          <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left uppercase">{{ data.AddingDroppingSubject.student_no }}</td>   
                    </tr>
                    <tr>
                      <th class="text-left"> STUDENT NAME </th>
                      <td class="text-left uppercase">{{ data.AddingDroppingSubject.student_name }}</td>   
                    </tr>
            ...
            <div class="col-md-6" >
              <div class="form-group">
                ...
                <select selectize style="height: 100px" ng-model="data.AddingDroppingSubject.college_id" autocomplete="off" ng-options="opt.id as opt.value for opt in colleges" ng-change="getCollegeProgram(data.AddingDroppingSubject.college_id)" data-validation-engine="validate[required]" disabled>
                  <option value=""></option>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-6" >
              <div class="form-group">
                ...
                <select selectize style="height: 100px" ng-model="data.AddingDroppingSubject.program_id" autocomplete="off" ng-options="opt.id as opt.value for opt in programs" ng-change="getProgram(data.AddingDroppingSubject.program_id)" data-validation-engine="validate[required]" disabled>
                  <option value=""></option>
                </select>
              </div>
            </div>
            ...
            <div class="clearfix"></div>
                    ...
                    <div class="col-md-3 pull-left">
                        <a class="btn btn-warning btn-sm btn-block" id="save" ng-click="addDropSubs()"><i class="fa fa-plus"></i>&nbsp;
                            ADD/DROP SUBJECT</a><br />
                    </div>
                ...
                <form id="add_subs">
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <select selectize ng-model="adata.course_title"
                              ng-options="opt.value as opt.value for opt in course"
                              ng-change="getCourse(adata.AddingDroppingSubjectSub.course_title)"
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <select class="form-control" ng-model="adata.status"
                ...
                <form id="edit_subs">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" ng-model="adata.chief_complaints"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" ng-model="adata.treatments"
                                data-validation-engine="validate[required]"></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
