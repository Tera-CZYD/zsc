  ...
  <div class="row">
    <div class="col-lg-12 mt-3">
      <div class="card">
        <div class="card-body">
          <div class="header-title">NEW STUDENT CLUB</div>
            ...
            <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left uppercase">{{ data.StudentClub.student_no }}</td>   
                    </tr>
                    <tr>
                      <th class="text-left"> STUDENT NAME </th> 
                      <td class="text-left uppercase">{{ data.StudentClub.student_name }}</td>   
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control uppercase" uppercase autocomplete="false" ng-model="data.StudentClub.position" data-validation-engine="validate[required]">
                </div>
              </div>
