<script type="text/javascript">
  ...
  handleAccess('pageAdd', 'completion form/add', currentUser);
...
<div class="row" id="pageAdd">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">ADD NEW COURSE COMPLETION FORM</div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="false" ng-model="data.Completion.serial_number" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label> CONTROL NO. </label>
                <input disabled type="text" class="form-control" ng-model="data.Completion.code">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <table class="table table-bordered">
                  <tr>
                    <td style="{{ data.Completion.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="uppercase">{{ data.Completion.student_name }}</td>
                    <td style="{{ data.Completion.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.Completion.student_name == undefined"><button class="btn btn-xs btn-sm  btn-danger" ng-click="data.Completion.student_name = null; data.Completion.student_id = null;" ng-init="data.Completion.student_id = null"><i class="fa fa-times"></i></button>
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-control" ng-model="data.Completion.semester" autocomplete="false" data-validation-engine="validate[required]" style="height: 44px">
                  <option value=""></option>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control datepicker" autocomplete="false" ng-model="data.Completion.date" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label> OR <i class="required">*</i></label>
                <input type="text" class="form-control uppercase" autocomplete="off" ng-model="data.Completion.or_no" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label> SCHOOL YEAR <i class="required">*</i></label>
                <input type="text" class="form-control uppercase" autocomplete="off" ng-model="data.Completion.school_year" data-validation-engine="validate[required]">
              </div>
            </div>
          </div>
        </form>
