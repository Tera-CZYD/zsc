<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'completion form/index', currentUser);
                  ...
                  <tr ng-repeat="data in datas">
                    ...
                    <td>
                      <div class="btn-group btn-group-xs">
                        ...
                        <a id="pageEdit" href="#/registrar/completion/edit/{{ data.id }}" class="btn btn-primary" ng-disabled="data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a>
