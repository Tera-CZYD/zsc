...
<div class="row" id="pageEdit">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">EDIT COMPLETION FORM</div>
              ...
              <div class="form-group">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td style="{{ data.Completion.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.Completion.student_name == undefined">
                      <button class="btn btn-xs btn-sm  btn-danger" ng-click="data.Completion.student_name = null; data.Completion.student_id = null;" ng-init="data.Completion.student_id = null"><i class="fa fa-times"></i></button>
                    </td>
                  </tr>
                </table>
              </div>
