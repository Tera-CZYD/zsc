<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'year level term management/index', currentUser);
  handleAccess('pageAdd', 'year level term management/add', currentUser);
  handleAccess('pageEdit', 'year level term management/edit', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">YEAR LEVEL TERM MANAGEMENT</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <a id="pageAdd" href="#/year-level-terms/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center">{{ data.educational_level }}</td>
                  <td>
                    <div class="btn-group btn-group-xs">
                      <a id="pageEdit" href="#/year-level-terms/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
