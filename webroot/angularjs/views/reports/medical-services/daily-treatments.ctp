<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'health and medical service/daily treatments', currentUser);
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-8 col-xs-12">
              <h4 class="header-title">DAILY TREATMENTS</h4>
            </div>
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr class="bg-info">
                  ...
                  <th class="text-center"> AILMENTS </th>
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-left uppercase">{{ data.patient_name }}</td>
                  <td class="text-center uppercase">
                    <div ng-repeat="subs in data.subs">{{ subs.ailments }}</div>
                  </td>
                  <td class="text-center uppercase">
                    <div ng-repeat="subs in data.subs">{{ subs.treatments }}</div>
                  </td>
                  <td class="text-left uppercase">
                    <div ng-repeat="subs in data.subs">{{ subs.remarks }}</div>
                  </td>
                </tr>
                <tr ng-show="datas == ''">
