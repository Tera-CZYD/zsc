<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'health and medical service/employee frequency', currentUser);
  handleAccess('pagePrint', 'health and medical service/employee frequency print', currentUser);
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-8 col-xs-12">
              <h4 class="header-title">EMPLOYEE CONSULTATION FREQUENCY</h4>
            </div>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center uppercase">{{ data.frequency }}</td>
