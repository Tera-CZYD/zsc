<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'health and medical service/monthly consumption', currentUser);
</script>
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr class="bg-info">
                  ...
                  <th class="text-center"> EXPIRY <br> DATE </th>
                  <th class="text-center"> STOCK <br> AVAILABLE </th>
                  <th class="text-center"> TOTAL </th>
                  <th class="text-center"> NUMBER <br> ISSUED </th>
