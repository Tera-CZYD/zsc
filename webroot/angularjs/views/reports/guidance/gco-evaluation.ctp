<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'report guidance/gco evaluation', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">GCO EVALUATION REPORT</h4>
        <div class="clearfix"></div><hr>

        <div class="col-md-4">
          <div class="form-group">
              <label> COUNSELOR <i class="required">*</i></label>
              <select class="form-control" ng-model="counselor_id" ng-options="opt.id as opt.value for opt in counselors">
              <option value=""></option>
            </select>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label>COLLEGE</label>
            <select class="form-control" ng-model="college_id" ng-options="opt.id as opt.value for opt in colleges" ng-change="getProgram(college_id)">
              <option value=""></option>
            </select>
          </div>
        </div>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center uppercase">{{ data.comments }}</td>
