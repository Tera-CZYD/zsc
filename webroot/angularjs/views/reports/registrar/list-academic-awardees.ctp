<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'report registrar/list academic awardees', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">LIST OF ACADEMIC AWARDEE</h4>
        <div class="clearfix"></div><hr>

        <div class="col-md-4">
          <div class="form-group">
              <label> SEMESTER <i class="required">*</i></label>
              <select class="form-control" ng-model="choice" autocomplete="false"
        ...
        <div class="col-md-4" ng-show="choice== 'Quarterly' || choice== 'Final'">
          <div class="form-group">
              <label> AWARD <i class="required">*</i></label>
              <select class="form-control" autocomplete="off"
                  data-validation-engine="validate[required]" ng-model="award" ng-change = "getData()" >
                  <option value=""></option>
                  <option value="2">Dean's Lister</option>
                  <option value="1">President's Lister</option>
              </select>
          </div>
        </div>

        <div class="col-md-4" ng-show="choice == 'Quarterly'">
          <div class="form-group">
        ...
        <div class="single-table mb-5">
          <div class="table-responsive">
            <table class="table table-bordered text-center">
              ...
              <tbody>
              <tr ng-repeat="data in datas" ng-show="awardMatch(data.award)">
                ...
                <td class="text-left">{{ data.ave }}</td>
                <td class="text-center">
                  <!-- {{ data.award === '1' ? 'President Lister' : (data.award === '2' ? 'Dean Lister' : '') }} -->
                  {{ data.award === '1' ? "President's Lister" : (data.award === '2' ? "Dean's Lister" : '') }}
                </td>
              </tr>
