<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'report registrar/student club list', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">LIST OF STUDENTS IN A CLUB </h4>
        <div class="clearfix"></div><hr>

        <div class="col-md-4">
          <div class="form-group">
            <label> CLUB </label>
            <select class="form-control" ng-model="club_id" ng-options="opt.id as opt.value for opt in clubs" ng-change = "getDatas(club_id)">
              <option value=""></option>
            </select>
          </div>
        </div> 
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center uppercase">{{ data.club }}</td>
                  <td class="text-center uppercase">{{ data.year }}</td>
                  <td class="text-center uppercase">{{ data.position }}</td>
                </tr>
                <tr ng-show="datas == ''">
