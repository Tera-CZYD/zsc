<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'report registrar/student rankings', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">STUDENT RANKINGS</h4>
          ...
          <div class="form-group col-md-3">
            <label> SEMESTER <i class="required">*</i></label>
              <select class="form-control" ng-model="choice" autocomplete="false"
                  data-validation-engine="validate[required]" style="height: 44px">
                  <option value=""></option>
                  <option value="Quarterly">Quarterly Ranking</option>
        ...
        <div class="col-md-3" ng-show="choice== 'Quarterly'">
          <div class="form-group">
        ...
        <div class="col-md-3" ng-show="choice== 'Final'">
          <div class="form-group">
...
<!--         <div class="col-md-4" ng-show="choice== 'Quarterly'">
          <div class="form-group">
            ...
            <select class="form-control" ng-model="year_term_id" ng-options="opt.id as opt.value for opt in year_terms" ng-change = "getQuarter(year_term_id)">
              <option value=""></option>
            </select>
          </div>
        </div> 
        ...
        <div class="col-md-4" ng-show="choice== 'Quarterly'">
          <div class="form-group">
            <label> COURSE </label>
            <select class="form-control" ng-model="program_id" ng-options="opt.id as opt.value for opt in programs" ng-change = "getData(program_id)">
              <option value=""></option>
            </select>
          </div>
        </div>  -->
