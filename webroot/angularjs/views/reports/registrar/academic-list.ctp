<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'report registrar/academic list', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title"> LIST OF BEST ACADEMIC STUDENTS</h4>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select selectize ng-model="section_id" ng-options="opt.id as opt.value for opt in sections">
              <option value=""></option>
            </select>
          </div>
        </div> 
        ...
        <!-- <div class="col-md-4">
          <div class="form-group">
            ...
            <select class="form-control" ng-model="year" ng-options="opt.id as opt.value for opt in year_terms" >
              <option value=""></option>
            </select>
          </div>
        </div>  -->
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select selectize  ng-model="semester" ng-change = "getData(semester)"
          ...
          <div class="col-md-4  pull-right" style="margin-top: 28.5px">
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center uppercase">{{ data.award_id }}</td>
                  <!-- <td class="text-center uppercase">{{ data.year }}</td> -->
