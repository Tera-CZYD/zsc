<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'admin management/index', currentUser);
  handleAccess('pageAdd', 'admin management/add', currentUser);
  handleAccess('pageView', 'admin management/view', currentUser);
  handleAccess('pageEdit', 'admin management/edit', currentUser);
  handleAccess('pageDelete', 'admin management/delete', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">ADMIN MANAGEMENT</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                <a id="pageIndex" href="#/settings/admin-management/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center">{{ data.employee_no }}</td>
                  <td class="text-center">{{ data.employee_name }}</td>
                  <td class="text-center">{{ data.department }}</td>
                  <td>
                    <div class="btn-group btn-group-xs">
                        <a id="pageView" href="#/settings/admin-management/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                      	<a id="pageEdit" href="#/settings/admin-management/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
