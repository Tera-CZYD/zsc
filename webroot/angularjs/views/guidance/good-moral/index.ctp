<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'good moral certificate/index', currentUser);
  handleAccess('pageAdd', 'good moral certificate/add', currentUser);
  handleAccess('pagePrint', 'good moral certificate/print', currentUser);
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    ...
                    <a id="pageAdd" href="#/guidance/good-moral/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                    ...
                    <tr ng-repeat="data in datas">
                      ...
                      <td>
                        <div class="btn-group btn-group-xs">
                          ...
                          <a id="pageView" href="#/guidance/good-moral/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          
                          
                          <a id="pageEdit" href="#/guidance/good-moral/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
