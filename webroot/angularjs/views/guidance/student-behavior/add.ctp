<script type="text/javascript">
  ...
  handleAccess('pageAdd', 'student behavior/add', currentUser);
...
<div class="row" id="pageAdd">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">NEW STUDENT BEHAVIOR</div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <table class="table table-bordered">
                  <tr>
                    <td style="{{ data.StudentBehavior.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="uppercase">{{ data.StudentBehavior.student_name }}</td>
                    <td style="{{ data.StudentBehavior.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.StudentBehavior.student_name == undefined">
                      <button class="btn btn-xs btn-sm  btn-danger" ng-click="data.StudentBehavior.student_name = null; data.StudentBehavior.student_id = null;" ng-init="data.StudentBehavior.student_id = null"><i class="fa fa-times"></i></button>
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select selectize ng-model="data.StudentBehavior.course_id" ng-options="opt.id as opt.value for opt in course" ng-change="getCourse(data.StudentBehavior.course_id)" data-validation-engine="validate[required]">
                  <option value=""></option>
                </select>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select selectize ng-model="data.StudentBehavior.year_term_id" ng-options="opt.id as opt.value for opt in year_terms" ng-change = "getYear(data.StudentBehavior.year_term_id)">
                  <option value=""></option>
                </select>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control datepicker" autocomplete="false" ng-model="data.StudentBehavior.date" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label> DESCRIPTION OF BEHAVIOR <i class="required">*</i></label>
                <textarea class="form-control" autocomplete="false" ng-model="data.StudentBehavior.behavior" data-validation-engine="validate[required]"></textarea>
              </div>
            </div>
          </div>
        </form>
