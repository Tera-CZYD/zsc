<script type="text/javascript">
  ...
  handleAccess('pageEdit', 'counseling intake/edit', currentUser);
...
<div class="row" id="pageEdit">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">EDIT COUNSELING INTAKE </div>
        ...
        <form id="form">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label> DATE APPLIED <i class="required">*</i></label>
                ...
                <div class="col-md-12">
                  <h6 class="radio-inline mx-3">
                    ...
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.school" value="1"> YES
                    </label>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.school" value="2"> NO
                    </label>
                  </h6>
                </div>
                <div class="col-md-12">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <h6 class="radio-inline mx-3">
                    ...
                    <i class="required">*</i>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.home" value="1"> YES
                    </label>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.home" value="2"> NO
                    </label>
                  </h6>
                </div>
                <div class="col-md-12">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <h6 class="radio-inline mx-3">
                    ...
                    <i class="required">*</i>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.bhouse" value="1"> YES
                    </label>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.bhouse" value="2"> NO
                    </label>
                  </h6>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <h6 class="radio-inline mx-3">
                    ...
                    <i class="required">*</i>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.bother" value="1"> YES
                    </label>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.bother" value="2"> NO
                    </label>
                  </h6>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <h6 class="radio-inline mx-3">
                    ...
                    <i class="required">*</i>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.guidance" value="1"> YES
                    </label>
                    <label class="radio-inline mx-2">
                      <input type="radio" autocomplete="false" ng-model="data.CounselingIntake.guidance" value="2"> NO
                    </label>
                  </h6>
                </div>
              </div>
