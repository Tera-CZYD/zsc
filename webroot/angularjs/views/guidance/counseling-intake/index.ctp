<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'counseling intake/index', currentUser);
  handleAccess('pageAdd', 'counseling intake/add', currentUser);
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                ...
                <a id="pageAdd" href="#/guidance/counseling-intake/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
                ...
                <tr ng-repeat="data in datas">
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                      	...
                      	<a id="pageView" href="#/guidance/counseling-intake/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
