          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input  type="text" class="form-control" ng-model="data.CounselingAppointment.serial_number"> 
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <table class="table table-bordered">
                  <tr>
                    <td style="{{ data.CounselingAppointment.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="uppercase">{{ data.CounselingAppointment.student_name }}</td>
                    <td style="{{ data.CounselingAppointment.student_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.CounselingAppointment.student_name == undefined">
                      <button class="btn btn-xs btn-sm  btn-danger" ng-click="data.CounselingAppointment.student_name = null; data.CounselingAppointment.student_id = null;" ng-init="data.CounselingAppointment.student_id = null"><i class="fa fa-times"></i></button>
                    </td>
                  </tr>  
                </table>  
              </div>
