...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">EDIT COUNSELING TYPE</div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="false" ng-model="data.CounselingType.name" data-validation-engine="validate[required]">
              </div>
            </div>
          </div>
        </form>
