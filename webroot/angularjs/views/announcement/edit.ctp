          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="false" ng-model="data.Announcement.title" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label> DATE <i class="required">*</i></label>
                <input type="text" class="form-control datepicker" autocomplete="false" ng-model="data.Announcement.date" data-validation-engine="validate[required]">
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <tr ng-repeat="data in announcementImage">
...
<script>
  ...
  document.getElementById('announcementImage').onchange = uploadOnChange;
  ...
  function uploadOnChange() {
    ...
    var files = $('#announcementImage')[0].files;
          ...
          <center>
            <ul class="list-group">
              <span class="btn btn-primary btn-min btn-file">
                ...
                <input ng-file-model="files" id="announcementImage" multiple="multiple" name="picture" class="form-control" type="file">
              </span>
            </ul>
          </center>
        </div>
