<?php if (hasAccess('chart of accounts/index', $currentUser)): ?>
<div class="row">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <?php if (hasAccess('chart of accounts/add', $currentUser)): ?>
                <a href="#/settings/accounts/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
              <?php endif ?> 
                ...
                <tr ng-repeat="data in datas">
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                      <?php if (hasAccess('chart of accounts/edit', $currentUser)): ?>
                        <a href="#/settings/accounts/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
                      <?php endif ?> 
                      <?php if (hasAccess('chart of accounts/delete', $currentUser)): ?>
