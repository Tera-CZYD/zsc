<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'academic term management/index', currentUser);
  handleAccess('pageAdd', 'academic term management/add', currentUser);
  handleAccess('pageEdit', 'academic term management/edit', currentUser);
...
<div class="row" id="pageIndex">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">ACADEMIC TERM MANAGEMENT</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <a id="pageAdd" href="#/academic-terms/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center">{{ data.school_year_start }}</td>
                  <td class="text-center">{{ data.school_year_end }}</td>
                  <td class="text-center">{{ data.year_term }}</td>
                  <td>
                    <div class="btn-group btn-group-xs">
                      <a id="pageEdit" href="#/academic-terms/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
