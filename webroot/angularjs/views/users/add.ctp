...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title"> NEW USER </div>
        ...
        <form id="form" >
          <div class="row">
                    ...
                    <table class="table table-bordered">
                      <tr>
                        ...
                        <td style="{{ data.User.employee_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.User.employee_name == undefined">
                          <button type="button" class="btn btn-xs btn-sm  btn-danger" ng-click="data.User.employee_name = null; data.User.employee_id = null;" ng-init="data.User.employee_id = null"><i class="fa fa-times"></i></button>
                        </td>
                      </tr>  
                    </table>  
                  </div>
            ...
            <div class="col-md-2">
              <div>
                <img src=" {{ url }}assets/img/user.jpg" class="img-responsive userImage"/>
              </div>
              <ul class="list-group">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="pull-right">
              <button type="button" class="btn btn-primary btn-min" id = "save" ng-click="save();"><i class="fa fa-save"></i> SAVE </button>
            </div>
          </div>
        </div>
      </div>
