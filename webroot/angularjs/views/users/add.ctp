                    ...
                    <table class="table table-bordered">
                      <tr>
                        ...
                        <td style="{{ data.User.employee_name == undefined ? 'padding:15px':'padding:5px !important'}}" class="w30px" ng-hide="data.User.employee_name == undefined">
                          <button type="button" class="btn btn-xs btn-sm  btn-danger" ng-click="data.User.employee_name = null; data.User.employeeId = null;" ng-init="data.User.employeeId = null"><i class="fa fa-times"></i></button>
                        </td>
                      </tr>  
                    </table>  
                  </div>
