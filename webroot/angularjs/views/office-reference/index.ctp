<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'office reference/index', currentUser);
  handleAccess('pageAdd', 'office reference/add', currentUser);
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                <a id="pageAdd" href="#/settings/office-reference/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
                ...
                <tr ng-repeat="data in datas">
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                        <a id="pageView" href="#/settings/office-reference/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                      	<a id="pageEdit" href="#/settings/office-reference/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
