<?php if (hasAccess('office reference/index', $currentUser)): ?>
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">OFFICE REFERENCES</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <?php if (hasAccess('office reference/add', $currentUser)): ?>
                <a href="#/settings/office-reference/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
              <?php endif ?> 
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center uppercase">{{ data.module }}</td>
                  <td class="text-center uppercase">{{ data.submodule }}</td>
                  <td class="text-center">{{ data.reference_code }}</td>
                  <td>
                    <div class="btn-group btn-group-xs">
                      <?php if (hasAccess('office reference/view', $currentUser)): ?>
                          <a href="#/settings/office-reference/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          <?php endif ?>
                      <?php if (hasAccess('office reference/edit', $currentUser)): ?>
                      	<a href="#/settings/office-reference/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
                      <?php endif ?> 
                      <?php if (hasAccess('office reference/delete', $currentUser)): ?>
