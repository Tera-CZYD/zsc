          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <table class="table table-bordered center">
                <tr>
                  <th class="text-left" rowspan="6"> CALL NUMBER </th>
                  <td class="text-left">
                ...
                <tr>
                  <td class="text-left">
                    <input type="text" autocomplete="false" class="form-control" ng-model="data.Bibliography.call_number4" data-validation-engine="validate[required]">
                  </td>
                </tr>
                <tr>
                  <td class="text-left">
                    <input type="text" autocomplete="false" class="form-control" ng-model="data.Bibliography.call_number5" data-validation-engine="validate[required]">
                  </td>
                </tr>
                <tr>
                  <td class="text-left">
                    <input type="text" autocomplete="false" class="form-control" ng-model="data.Bibliography.call_number6" data-validation-engine="validate[required]">
                  </td>
                </tr>
              </table>
            </div>
