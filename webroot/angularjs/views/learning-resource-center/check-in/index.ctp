<script type="text/javascript">
  ...
  handleAccess('pageIndex', 'check in/index', currentUser);
  handleAccess('pageAdd', 'check in/add', currentUser);
  handleAccess('pagePrint', 'check in/print', currentUser);
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <a id="pageAdd" href="#/learning-resource-center/check-in/add" class="btn btn-primary  btn-min"><i class="fa fa-retweet"></i> RETURN ITEM</a>
                ...
                <tr ng-repeat="data in datas">
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                      ...
                      <a id="pageView" href="#/learning-resource-center/check-in/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                      
                      
                      <a id="pageEdit" href="#/learning-resource-center/check-in/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a> 
