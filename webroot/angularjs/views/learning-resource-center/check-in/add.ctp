<script type="text/javascript">
  ...
  handleAccess('pageAdd', 'check in/add', currentUser);
...
<div class="row" id="pageAdd">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">NEW CHECK-IN</div>
        ...
        <form id="form">
          ...
          <div class="col-md-12">
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                <tr>
                  ...
                  <td class="italic">{{ data.CheckIn.learning_resource_member_id }}</td>
                </tr>
                <tr>
                  <th class="text-right"> MEMBER NAME : </th>
                  <td style="{{ data.CheckIn.member_name == undefined ? 'padding:15px':'padding:13px !important'}}" class="uppercase">{{ data.CheckIn.member_name }}</td>
                </tr>
                <tr>
                  <th class="text-right"> EMAIL : </th>
                  <td class="italic">{{ data.CheckIn.email }}</td>
                </tr>
              </table>
            </div> 
           ...
           <div class="col-md-12" ng-show="data.CheckIn.member_name != undefined">
            <div class="clearfix"></div><hr>
            <div class="header-title">ITEMS RETURNED</div>

            <div class="clearfix"></div><hr>

            <button type="button" class="btn btn-warning  btn-min" ng-click="checkIn()">RETURN SELECTED ITEMS</button>
            <button type="button" id="btn"  class="btn btn-warning btn-min" ng-click="checkInAll(data)">RETURN ALL ITEMS</button>
...
<div class="modal fade" id="add-returnDate-modal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="return_date">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control datepicker" autocomplete="off" ng-model="datas.date_returned" data-validation-engine="validate[required]">
            </div>
          </div>
        </form>
       </div> 
       <div class="modal-footer">
        ...
        <button type="button" id="save" class="btn btn-primary btn-sm btn-min" ng-click="saveCheckIn(datas)"> SAVE </button>
      </div> 
    </div>
  </div>
</div>