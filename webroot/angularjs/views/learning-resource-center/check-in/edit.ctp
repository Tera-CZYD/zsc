...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">EDIT CHECK-IN</div>
           ...
           <div class="col-md-12">
            ...
            <div class="table-responsive">
              <table class="table table-bordered text-center" id="myTable">
                ...
                <tbody>
                  <tr ng-repeat="datas in datax">
                    <td>
                      <input icheck type="checkbox" ng-model="datas.selected">
                    </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="modal-footer">
        ...
        <button type="button" id="save" class="btn btn-primary btn-sm btn-min" ng-click="updateCheckIn(datas)"> SAVE </button>
      </div> 
    </div>
  </div>
</div>