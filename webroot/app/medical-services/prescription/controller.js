app.controller('PrescriptionController', function($scope, Prescription) {
  ...
  $scope.load = function(options) {
    ...
    Prescription.query(options, function(e) {
  ...
  $scope.remove = function(data) {
    ...
    bootbox.confirm('Are you sure you want to delete ' + data.name +' ?', function(c) {
      ...
      if (c) {
        ...
        Prescription.remove({ id: data.id }, function(e) {
  ...
  $scope.print = function(){
    ...
    if ($scope.conditionsPrint !== '') {
      ...
      printTable(base + 'print/prescription?print=1' + $scope.conditionsPrint);

    }else{

      printTable(base + 'print/prescription?print=1');
  ...
  app.controller('PrescriptionAddController', function($scope, Prescription, Select) {
   ...
   $('.clockpicker').clockpicker({
    ...
    $scope.save = function() {
      ...
      if (valid) {
        ...
        Prescription.save($scope.data, function(e) {
          ...
          if (e.ok) {
            ...
            window.location = '#/medical-services/prescription';
  ...
  app.controller('PrescriptionViewController', function($scope, $routeParams, Prescription) {
    ...
    $scope.load = function() {
        ...
        Prescription.get({ id: $scope.id }, function(e) {
    ...
    $scope.print = function(id){
      ...
      printTable(base + 'print/prescription_form/'+id);
  ...
  app.controller('PrescriptionEditController', function($scope, $routeParams, Prescription, Select) {
   ...
   $('.clockpicker').clockpicker({
    ...
    $scope.update = function() {
      ...
      if (valid) {
        ...
        Prescription.update({id:$scope.id}, $scope.data, function(e) {
