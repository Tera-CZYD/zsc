app.controller('AdminParticipantEvaluationActivityController', function($scope, $window, ParticipantEvaluationActivity) {
...
app.controller('AdminParticipantEvaluationActivityAddController', function($scope, ParticipantEvaluationActivity, Select) {
...
app.controller('AdminParticipantEvaluationActivityViewController', function($scope, $routeParams, ParticipantEvaluationActivity) {
...
app.controller('AdminParticipantEvaluationActivityEditController', function($scope, $routeParams, ParticipantEvaluationActivity, Select) {
