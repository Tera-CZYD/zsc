app.controller('StudentApartelleController', function($scope, $window, StudentApartelle) {
  ...
  $scope.load = function(options) {
    ...
    StudentApartelle.query(options, function(e) {
  ...
  $scope.print = function(){
    ...
    if ($scope.conditionsPrint !== '') {
      ...
      printTable(base + 'print/student_apartelle?print=1' + $scope.conditionsPrint);

    }else{

      printTable(base + 'print/student_apartelle?print=1');
...
app.controller('StudentApartelleViewController', function($scope, $routeParams, StudentApartelle) {
  ...
  $scope.load = function() {
    ...
    StudentApartelle.get({ id: $scope.id }, function(e) {
  ...
  $scope.remove = function(data) {
    ...
    bootbox.confirm('Are you sure you want to remove '+ data.code +' ?', function(c) {
      ...
      if (c) {
        ...
        StudentApartelle.remove({ id: data.id }, function(e) {
          ...
          if (e.ok) {
            ...
            window.location = "#/corporate-affairs/student-apartelle";
