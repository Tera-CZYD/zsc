 ...
 * License: https://www.anychart.com/
...
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.Xe($.De(window.document,"head",void 0,void 0)[0],c,0);NE=!0}this.Sd||(this.Sd=$.Oe("DIV","anychart-credits"));this.i||(this.i=$.Oe("A"),this.D=$.Oe("SPAN","anychart-credits-text"),this.b=$.Oe(),Ve(this.i,this.D),this.Sd.appendChild(this.i));b=this.f.Pl();this.J(ml)&&(b&&b.appendChild(this.Sd),this.I(ml));this.J(nl)&&(b=$.ic.apply(null,[", v%s.%s.%s.%s"].concat(["8","11","0",
...
$.F("anychart.onDocumentReady",function(a,b){$.ll.isNodeJS&&(dq=!0);if(dq)a.call(b);else if(eq||(eq=[]),eq.push([a,b]),"complete"===$.Pp.readyState)(0,window.setTimeout)(cq,1);else{var c=$.ll;$.Ld($.Pp,["DOMContentLoaded","readystatechange"],bq,!1);$.Ld(c,"load",bq,!1)}});$.F("",function(a){$.n(a)&&(fq=a);return fq});
